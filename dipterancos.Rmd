...
ggplot(antssimplegenera, aes(x = year, fill=scientificName)) +
      geom_histogram(position = "identity", alpha = 0.5, binwidth=0.5, na.rm = FALSE, show.legend = FALSE) + 
  theme_bw() + labs(x= "Year Collected", y= "Number of Occurences", title = "Specimens Collected in Last 70 years (1949-2019)")
```
